...
st.set_page_config(
    page_title='宗教堂的40公開課 Chatbot\n(Powered by Mistral 7B)'
)

# Create a header element
st.header("宗教堂的40公開課 Chatbot")
st.header("(Powered by Mistral 7B)")
...
You speak in English by Default. Only when someone speak to you in Chinese you response in Chinese, otherwise you speak English
'''
